{
  ...
  */
  mkAction = type: payload:
    { _kind = "action"; inherit type; } // payload;
  ...
  */
  mkTarget = type: payload:
    { _kind = "target"; inherit type; } // payload;
  ...
  */
  mkMatcher =
    ...
    assert builtins.elem (target._kind or null) [ "action" "locator" "target" ];
